...
`,f=l.default.p.withConfig({componentId:"zh_mobile_web__sc-6efeea3b-4"})`
  ...
  line-height: 22px;
  color: #d1d5db;
`;var m=e.i(43174),g=e.i(80629);let p=(0,n.observer)(function(){let e=(0,i.useRouter)(),n=(0,i.useSearchParams)(),l=(0,o.useRef)(null),a=(0,o.useRef)(null),s=n.get("clientId"),u=n.get("serviceWorkerId"),h=(0,d.isServiceWorkerDocumentFlow)(u)?m.default.serviceWorker.documentManagement:m.default.client.documentManagement,f=(0,g.getServiceType)(n.get("serviceType")),p=n.get("contractId"),k=n.get("templateId"),M=n.get("documentId"),L=n.get("documentStatus"),$=n.get("monthlyScheduleClientContractId"),T=n.get("monthlyScheduleYearMonth"),[H,E]=(0,o.useState)(null),[D,P]=(0,o.useState)({height:0,width:0}),R=(0,o.useMemo)(()=>{let e=D.width,t=D.height;return e<=0||t<=0?null:e/t>210/297?{height:`${t}px`,width:"auto"}:{height:"auto",width:`${e}px`}},[D.height,D.width]);return(0,o.useEffect)(()=>{let e=!0,t=null;return(async()=>{let n=navigator.mediaDevices;if(void 0===n||void 0===n.getUserMedia)return E("이 브라우저에서는 카메라를 지원하지 않습니다.");try{if(t=await n.getUserMedia({audio:!1,video:{facingMode:"environment"}}),!e)return void t.getTracks().forEach(e=>e.stop());let i=l.current;if(null===i)return void t.getTracks().forEach(e=>e.stop());i.srcObject=t,await i.play()}catch{e&&E("카메라를 불러오지 못했습니다.\n권한을 확인해 주세요.")}})(),()=>{e=!1,t?.getTracks().forEach(e=>e.stop())}},[]),(0,o.useEffect)(()=>{let e=a.current;if(null===e)return;let t=()=>{P({width:Math.floor(e.clientWidth-24),height:Math.floor(e.clientHeight-24)})};t();let n=new ResizeObserver(t);return n.observe(e),()=>{n.disconnect()}},[]),(0,t.jsx)(c,{children:(0,t.jsxs)(w,{children:[(0,t.jsx)(b,{children:(0,t.jsx)(r.default,{title:"",onBack:()=>e.push((0,d.buildDocumentFlowHref)({clientId:s,serviceType:f,contractId:p,templateId:k??"",documentId:M,documentStatus:L,monthlyScheduleClientContractId:$,monthlyScheduleYearMonth:T,page:"capture-guide",serviceWorkerId:u}))})}),(0,t.jsx)(x,{ref:a,children:(0,t.jsxs)(_,{style:R??void 0,children:[(0,t.jsx)(I,{$position:"top-left"}),(0,t.jsx)(I,{$position:"top-right"}),(0,t.jsx)(I,{$position:"bottom-left"}),(0,t.jsx)(I,{$position:"bottom-right"}),(0,t.jsx)(v,{children:null!==H?(0,t.jsx)(S,{children:H}):(0,t.jsx)(j,{ref:l,autoPlay:!0,muted:!0,playsInline:!0})})]})}),(0,t.jsxs)(y,{children:[(0,t.jsx)(C,{children:"서류를 화면 안에 맞춰서 촬영해주세요."}),(0,t.jsx)(z,{type:"button","aria-label":"촬영하기",onClick:()=>{let t=l.current;if(null===t||0===t.videoWidth||0===t.videoHeight)return;let n=210/297,i=t.videoWidth,o=t.videoHeight,r=i,c=o;i/o>n?r=Math.floor(o*n):c=Math.floor(i/n);let a=Math.floor((i-r)/2),m=Math.floor((o-c)/2),g=document.createElement("canvas");g.width=r,g.height=c;let w=g.getContext("2d");if(null===w)return;w.drawImage(t,a,m,r,c,0,0,g.width,g.height);let b=g.toDataURL("image/jpeg",.92);h.setCapturedPhotoDataUrl(b),e.push((0,d.buildDocumentFlowHref)({clientId:s,serviceType:f,contractId:p,templateId:k??"",documentId:M,documentStatus:L,monthlyScheduleClientContractId:$,monthlyScheduleYearMonth:T,page:"photo-review",serviceWorkerId:u}))}})]})]})})}),w=l.default.div.withConfig({componentId:"zh_mobile_web__sc-4edc0dc4-0"})`
  display: flex;
  flex: 1 0 0;
  flex-direction: column;
...
`,j=l.default.video.withConfig({componentId:"zh_mobile_web__sc-4edc0dc4-6"})`
  ...
  height: 100%;
  object-fit: cover;
`,S=l.default.div.withConfig({componentId:"zh_mobile_web__sc-4edc0dc4-7"})`
  display: flex;
  align-items: center;
  justify-content: center;

...
`,b=d.default.section.withConfig({componentId:"zh_mobile_web__sc-b6c28679-1"})`
  ...
  background: #f8fafc;
`,x=d.default.div.withConfig({componentId:"zh_mobile_web__sc-b6c28679-2"})`
  display: flex;
  gap: 6px;
  align-items: center;
  align-self: stretch;
...
`,T=d.default.p.withConfig({componentId:"zh_mobile_web__sc-b6c28679-10"})`
  ${S}
  background: #ff6900;
`,z=d.default.p.withConfig({componentId:"zh_mobile_web__sc-b6c28679-11"})`
  ${S}
  background: #ff6900;
`,P=(0,d.default)(c.default).withConfig({componentId:"zh_mobile_web__sc-b6c28679-12"})`
  display: flex;
  flex-shrink: 0;
  gap: 2px;
  align-items: center;
...
`,L=d.default.div.withConfig({componentId:"zh_mobile_web__sc-b6c28679-13"})`
  display: flex;
  flex-direction: column;
  gap: 4px;
`,R=d.default.div.withConfig({componentId:"zh_mobile_web__sc-b6c28679-14"})`
  display: flex;
  gap: 8px;
  align-items: flex-start;
  ...
  line-height: normal;
  color: #0a0a0a;
`,$=d.default.span.withConfig({componentId:"zh_mobile_web__sc-b6c28679-15"})`
  flex-shrink: 0;
  width: 52px;
`,U=d.default.span.withConfig({componentId:"zh_mobile_web__sc-b6c28679-16"})`
  ...
  width: 1px;
  background: #e5e7eb;
`,O=d.default.span.withConfig({componentId:"zh_mobile_web__sc-b6c28679-17"})`
  min-width: 0;
  color: ${({$lightgray:e})=>!0===e?"#45464E":"inherit"};
`;function k(){return(0,t.jsxs)(E,{children:[(0,t.jsx)(r,{}),(0,t.jsxs)(N,{children:[(0,t.jsx)(M,{children:"검색 결과가 없습니다."}),(0,t.jsx)(A,{children:"이름을 다시 확인해주세요."})]})]})}let E=d.default.div.withConfig({componentId:"zh_mobile_web__sc-b6c28679-18"})`
  display: flex;
  flex: 1 0 0;
  flex-direction: column;
  gap: 16px;
  ...
  color: #494f53;
`,N=d.default.div.withConfig({componentId:"zh_mobile_web__sc-b6c28679-19"})`
  display: flex;
  flex-direction: column;
  gap: 8px;
  align-items: center;
  justify-content: center;
`,M=d.default.div.withConfig({componentId:"zh_mobile_web__sc-b6c28679-20"})`
  font-size: 18px;
  font-weight: 700;
  font-style: normal;
  line-height: normal;
`,A=d.default.div.withConfig({componentId:"zh_mobile_web__sc-b6c28679-21"})`
  font-size: 18px;
  font-weight: 400;
  font-style: normal;
  line-height: normal;

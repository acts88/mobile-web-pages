...
`;e.s(["default",0,function({title:e,titleAction:l,onBack:h,onForward:f,subtitle:m}){let p=null!=m&&""!==m;return(0,t.jsxs)(o,{children:[(0,t.jsxs)(r,{children:[(0,t.jsx)(a,{children:h?(0,t.jsx)(d,{onClick:h,children:(0,t.jsx)(n.default,{})}):null}),(0,t.jsx)(s,{children:e}),(0,t.jsxs)(c,{children:[l,f?(0,t.jsx)(d,{onClick:f,children:(0,t.jsx)(i.default,{})}):null]})]}),p?(0,t.jsx)(u,{children:m}):null]})}])},98273,e=>{"use strict";var t=e.i(25521),n=e.i(9735),i=e.i(38803);let l=i.default.div.withConfig({componentId:"zh_mobile_web__sc-ef8aca21-0"})`
  ...
  mask-size: contain;
`;function o(e){return function({size:t,color:i,style:o}){return(0,n.jsx)(l,{size:t,color:i,$src:e,style:o})}}let{PUBLIC_PATH:r}=t.default.env,a={Docs:o(`${r}/icon/docs.svg`),FrameSource:o(`${r}/icon/frame-source.svg`),EvShadow:o(`${r}/icon/ev-shadow.svg`),DocumentSearch:o(`${r}/icon/document-search.svg`),WandShine:o(`${r}/icon/wand-shine.svg`)};e.s(["default",0,a],98273)},10703,e=>{"use strict";var t=e.i(9735),n=e.i(88552);e.i(3159);var i=e.i(46907),l=e.i(33261),o=e.i(7744),r=e.i(38803),a=e.i(51413),c=e.i(98273),d=e.i(81911),s=e.i(62659),u=e.i(43174),h=e.i(43172),f=e.i(80629);let m=(0,i.observer)(function(){let e=(0,l.useRouter)(),i=(0,l.useSearchParams)(),r=(0,o.useRef)(null),s=i.get("clientId"),m=i.get("serviceWorkerId"),z=(0,a.isServiceWorkerDocumentFlow)(m),U=u.default.serviceWorker.documentManagement,G=z?U:u.default.client.documentManagement,q=(0,f.getServiceType)(i.get("serviceType")),Y=i.get("contractId"),K=i.get("templateId"),X=i.get("documentId"),J=i.get("documentStatus"),Q=i.get("monthlyScheduleClientContractId"),V=i.get("monthlyScheduleYearMonth"),Z=G.updateNeededDocumentCards.find(e=>e.templateId===K&&(null===X||X===e.id))??G.updateNeededDocumentCards.find(e=>e.templateId===K),ee=G.templates.find(e=>e.id===K),et=Z?.name??ee?.name??null,en=z&&"NEED_UPDATE"===J&&(0,h.isSalaryProvisionMonthlyScheduleDocument)(et),ei=et??"서류",el=function(e){let t=e.trim();if(0===t.length)return"를";let n=t.at(-1);if(void 0===n)return"를";let i=n.charCodeAt(0);return i<44032||i>55203?"를":(i-44032)%28!=0?"을":"를"}(ei),eo=G.capturedPhotoDataUrl,[er,ea]=(0,o.useState)({height:0,width:0}),[ec,ed]=(0,o.useState)(0),[es,eu]=(0,o.useState)(!1),[eh,ef]=(0,o.useState)(!1),em=en?U.monthlyScheduleCreateStatus:G.ocrAnalyzeStatus,ep="loading"===em,eg="success"===em,ex=ep||eh,e_=en&&(null===U.monthlyScheduleClientContractId||""===U.monthlyScheduleYearMonth.trim()),ew=()=>{e.push((0,a.buildDocumentFlowHref)({clientId:s,serviceType:q,contractId:Y,templateId:K??"",documentId:X,documentStatus:J,monthlyScheduleClientContractId:Q,monthlyScheduleYearMonth:V,page:"capture",serviceWorkerId:m}))},eb=(0,o.useMemo)(()=>{let e=er.width,t=er.height;return e<=0||t<=0?null:e/t>210/297?{height:`${t}px`,width:"auto"}:{height:"auto",width:`${e}px`}},[er.height,er.width]);(0,o.useEffect)(()=>{G.resetOcrAnalyze(),U.resetMonthlyScheduleDocumentCreate()},[G,U]),(0,o.useEffect)(()=>{let e=r.current;if(null===e)return;let t=()=>{ea({width:Math.floor(e.clientWidth-40),height:Math.floor(e.clientHeight-40)})};t();let n=new ResizeObserver(t);return n.observe(e),()=>{n.disconnect()}},[]),(0,o.useEffect)(()=>{if(es&&eg&&!eh){if("NEED_MATCHING"===J)return void e.push((0,a.buildDocumentFlowHref)({clientId:s,serviceType:q,templateId:K,contractId:Y,documentId:X,documentStatus:J,monthlyScheduleClientContractId:Q,monthlyScheduleYearMonth:V,page:"comparison",serviceWorkerId:m}));if(en)return void U.refreshDocuments().finally(()=>{e.push((0,a.buildDocumentFlowHref)({clientId:s,serviceType:q,page:"save-success",serviceWorkerId:m}))});e.push((0,a.buildDocumentFlowHref)({clientId:s,serviceType:q,contractId:Y,templateId:K??"",documentId:X,page:"photo-result",serviceWorkerId:m}))}},[s,Y,X,J,es,eh,eg,en,Q,V,e,U,q,m,K]),(0,o.useEffect)(()=>{if(!ep)return;let e=performance.now(),t=0,n=i=>{ed(Math.min(100*(1-Math.exp(-((i-e)/1e3*.05))),98)),t=window.requestAnimationFrame(n)};return t=window.requestAnimationFrame(n),()=>{window.cancelAnimationFrame(t)}},[ep]);let eI=async()=>{if(null===eo||null===K||""===K.trim()||e_)return;G.resetOcrAnalyze(),eu(!0),ed(0);let e=await fetch(eo),t=await e.blob(),n=new File([t],"document-photo.jpg",{type:t.type||"image/jpeg"});if(en)return void U.requestMonthlyScheduleDocumentCreate(n);if(null!==X&&""!==X.trim()){if(z)return void u.default.serviceWorker.documentManagement.requestOcrAnalyze({documentId:X,file:n});u.default.client.documentManagement.requestOcrAnalyze("NEED_MATCHING"===J?{templateId:K,file:n}:{templateId:K,documentId:X,file:n})}};return ex?(0,t.jsxs)(p,{children:[(0,t.jsx)(g,{children:(0,t.jsx)(d.default,{title:"사진 분석하기",onBack:()=>ef(!0)})}),(0,t.jsx)(x,{}),(0,t.jsx)($,{children:(0,t.jsxs)(D,{children:[(0,t.jsx)(c.default.DocumentSearch,{size:20}),(0,t.jsxs)(A,{children:[(0,t.jsx)(M,{children:"업로드한 사진을 분석하고 있습니다."}),(0,t.jsx)(H,{children:"화면을 절대 끄지 마세요."})]}),(0,t.jsx)(E,{children:(0,t.jsx)(N,{$progress:ec})})]})}),eh?(0,t.jsx)(P,{role:"presentation",children:(0,t.jsxs)(T,{role:"dialog","aria-modal":"true","aria-labelledby":"abort-confirm-title","aria-describedby":"abort-confirm-description",onClick:e=>{e.stopPropagation()},children:[(0,t.jsxs)(F,{children:[(0,t.jsx)(L,{id:"abort-confirm-title",children:"작업을 중단할까요?"}),(0,t.jsx)(O,{id:"abort-confirm-description",children:"저장하지 않은 내용은 사라집니다."})]}),(0,t.jsxs)(R,{children:[(0,t.jsx)(B,{type:"button",onClick:()=>{ef(!1)},children:"계속하기"}),(0,t.jsx)(W,{type:"button",onClick:()=>{ef(!1),G.resetOcrAnalyze(),e.push((0,a.buildDocumentFlowHref)({clientId:s,serviceType:q,contractId:Y,templateId:K??"",documentId:X,documentStatus:J,monthlyScheduleClientContractId:Q,monthlyScheduleYearMonth:V,page:"capture-guide",serviceWorkerId:m}))},children:"중단하기"})]})]})}):null]}):(0,t.jsxs)(p,{children:[(0,t.jsx)(g,{children:(0,t.jsx)(d.default,{title:"NEED_MATCHING"===J?et??"서류 비교하기":"사진 확인하기",onBack:ew})}),(0,t.jsx)(x,{}),(0,t.jsxs)(_,{children:[(0,t.jsxs)(w,{children:["NEED_MATCHING"===J?`수기 ${ei}${el} 확인해 주세요.`:"촬영한 사진을 확인해 주세요.",(0,t.jsx)("br",{}),"NEED_MATCHING"===J?`전산 ${et}의 내용과 비교분석을 시작합니다.`:"잘못 촬영했다면 다시 촬영하기를 눌러주세요."]}),"error"===em?(0,t.jsx)(b,{children:"사진 분석에 실패했습니다. 네트워크 상태를 확인한 뒤 다시 시도해 주세요."}):null,(0,t.jsx)(I,{ref:r,children:(0,t.jsx)(y,{style:eb??void 0,children:null===eo?(0,t.jsx)(C,{children:"사진을 불러올 수 없습니다."}):(0,t.jsx)(v,{src:eo,alt:"촬영한 사진"})})})]}),(0,t.jsxs)(j,{children:[(0,t.jsx)(S,{type:"button",onClick:ew,children:"다시 촬영하기"}),(0,t.jsxs)(k,{type:"button",onClick:()=>{eI()},disabled:null===eo||null===K||!en&&null===X||e_||ep,$processing:ep,children:[(0,t.jsx)("span",{children:"NEED_MATCHING"===J?"비교 분석 시작":"분석 시작하기"}),(0,t.jsx)(n.default,{sx:{fontSize:20}})]})]})]})}),p=r.default.div.withConfig({componentId:"zh_mobile_web__sc-a7326e26-0"})`
  display: flex;
  flex: 1 0 0;
  flex-direction: column;
...
`,y=r.default.div.withConfig({componentId:"zh_mobile_web__sc-a7326e26-7"})`
  ...
  background: #fff;
`,v=r.default.img.withConfig({componentId:"zh_mobile_web__sc-a7326e26-8"})`
  display: block;
  width: 100%;
  height: 100%;
  object-fit: contain;
`,C=r.default.div.withConfig({componentId:"zh_mobile_web__sc-a7326e26-9"})`
  display: flex;
  align-items: center;
  justify-content: center;
...
`,E=r.default.div.withConfig({componentId:"zh_mobile_web__sc-a7326e26-18"})`
  ...
  background: #e6e0ff;
`,N=r.default.div.attrs(({$progress:e})=>({style:{transform:`scaleX(${e/100})`}})).withConfig({componentId:"zh_mobile_web__sc-a7326e26-19"})`
  ...
  background: #5635ff;
`,P=r.default.div.withConfig({componentId:"zh_mobile_web__sc-a7326e26-20"})`
  position: fixed;
  z-index: 1000;
  inset: 0;
...
`,T=r.default.div.withConfig({componentId:"zh_mobile_web__sc-a7326e26-21"})`
  display: flex;
  flex-direction: column;
  gap: 24px;

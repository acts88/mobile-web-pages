...
`;e.s(["default",0,function({title:e,titleAction:l,onBack:h,onForward:f,subtitle:m}){let p=null!=m&&""!==m;return(0,t.jsxs)(o,{children:[(0,t.jsxs)(d,{children:[(0,t.jsx)(c,{children:h?(0,t.jsx)(s,{onClick:h,children:(0,t.jsx)(n.default,{})}):null}),(0,t.jsx)(a,{children:e}),(0,t.jsxs)(r,{children:[l,f?(0,t.jsx)(s,{onClick:f,children:(0,t.jsx)(i.default,{})}):null]})]}),p?(0,t.jsx)(u,{children:m}):null]})}])},98273,e=>{"use strict";var t=e.i(25521),n=e.i(9735),i=e.i(38803);let l=i.default.div.withConfig({componentId:"zh_mobile_web__sc-ef8aca21-0"})`
  ...
  mask-size: contain;
`;function o(e){return function({size:t,color:i,style:o}){return(0,n.jsx)(l,{size:t,color:i,$src:e,style:o})}}let{PUBLIC_PATH:d}=t.default.env,c={Docs:o(`${d}/icon/docs.svg`),FrameSource:o(`${d}/icon/frame-source.svg`),EvShadow:o(`${d}/icon/ev-shadow.svg`),DocumentSearch:o(`${d}/icon/document-search.svg`),WandShine:o(`${d}/icon/wand-shine.svg`)};e.s(["default",0,c],98273)},48464,e=>{"use strict";var t=e.i(9735);e.i(3159);var n=e.i(46907),i=e.i(33261),l=e.i(7744),o=e.i(38803),d=e.i(51413),c=e.i(98273),r=e.i(81911),s=e.i(62659),a=e.i(43174),u=e.i(80629);let h=(0,n.observer)(function(){let e=(0,i.useRouter)(),n=(0,i.useSearchParams)(),o=(0,l.useRef)(null),s=n.get("clientId"),h=n.get("serviceWorkerId"),H=(0,d.isServiceWorkerDocumentFlow)(h),P=H?a.default.serviceWorker.documentManagement:a.default.client.documentManagement,R=(0,u.getServiceType)(n.get("serviceType")),L=n.get("contractId"),M=n.get("templateId"),T=n.get("documentId"),F=n.get("documentStatus"),U=n.get("monthlyScheduleClientContractId"),A=n.get("monthlyScheduleYearMonth"),E=P.templates.find(e=>e.id===M),B=E?.templateImagePath?.[0]??null,[O,W]=(0,l.useState)({height:0,width:0}),N=(0,l.useMemo)(()=>{let e=O.width,t=O.height;return e<=0||t<=0?null:e/t>210/297?{height:`${t}px`,width:"auto"}:{height:"auto",width:`${e}px`}},[O.height,O.width]);return(0,l.useEffect)(()=>{if(!H)return P.setContext(s,R),()=>{P.clearContext()}},[s,P,H,R]),(0,l.useEffect)(()=>{let e=o.current;if(null===e)return;let t=t=>{let{width:n,height:i}=t?.contentRect??e.getBoundingClientRect();W({width:Math.floor(n),height:Math.floor(i)})};t();let n=new ResizeObserver(e=>{t(e[0])});return n.observe(e),()=>{n.disconnect()}},[]),(0,t.jsxs)(f,{children:[(0,t.jsx)(m,{children:(0,t.jsx)(r.default,{title:"촬영 가이드",onBack:()=>e.push((0,d.buildDocumentFlowHref)({clientId:s,serviceType:R,contractId:L,templateId:M??"",documentId:T,documentStatus:F,monthlyScheduleClientContractId:U,monthlyScheduleYearMonth:A,page:"input-method",serviceWorkerId:h}))})}),(0,t.jsx)(p,{}),(0,t.jsxs)(g,{children:[(0,t.jsxs)(x,{children:[(0,t.jsx)(b,{children:"서류를 준비해주세요."}),(0,t.jsx)(b,{children:"준비가 완료되면 ‘촬영하기’ 버튼을 눌러 주세요."})]}),(0,t.jsx)(w,{ref:o,children:(0,t.jsxs)(_,{style:N??void 0,children:[(0,t.jsx)(j,{$position:"top-left"}),(0,t.jsx)(j,{$position:"top-right"}),(0,t.jsx)(j,{$position:"bottom-left"}),(0,t.jsx)(j,{$position:"bottom-right"}),(0,t.jsx)(v,{children:null===B?(0,t.jsx)(S,{children:"서류 미리보기"}):(0,t.jsx)(I,{src:B,alt:"서류 미리보기"})})]})}),(0,t.jsxs)(C,{children:[(0,t.jsxs)(y,{children:[(0,t.jsx)(z,{children:(0,t.jsx)(c.default.Docs,{size:32})}),(0,t.jsxs)($,{children:["세로로",(0,t.jsx)("br",{}),"촬영 해주세요."]})]}),(0,t.jsxs)(y,{children:[(0,t.jsx)(z,{children:(0,t.jsx)(c.default.FrameSource,{size:32})}),(0,t.jsxs)($,{children:["글씨가",(0,t.jsx)("br",{}),"잘리면 안돼요."]})]}),(0,t.jsxs)(y,{children:[(0,t.jsx)(z,{children:(0,t.jsx)(c.default.EvShadow,{size:32})}),(0,t.jsxs)($,{children:["그림자가",(0,t.jsx)("br",{}),"생기면 안돼요."]})]})]})]}),(0,t.jsx)(k,{children:(0,t.jsx)(D,{type:"button",onClick:()=>e.push((0,d.buildDocumentFlowHref)({clientId:s,serviceType:R,contractId:L,templateId:M??"",documentId:T,documentStatus:F,monthlyScheduleClientContractId:U,monthlyScheduleYearMonth:A,page:"capture",serviceWorkerId:h})),disabled:null===M||""===M,children:"촬영하기"})})]})}),f=o.default.div.withConfig({componentId:"zh_mobile_web__sc-a6b2f0d9-0"})`
  display: flex;
  flex: 1 0 0;
  flex-direction: column;
...
`,b=o.default.div.withConfig({componentId:"zh_mobile_web__sc-a6b2f0d9-5"})`
  ...
  color: #0a0a0a;
  text-align: center;
`,w=o.default.div.withConfig({componentId:"zh_mobile_web__sc-a6b2f0d9-6"})`
  display: flex;
  flex: 1 1 auto;
  align-items: center;
  justify-content: center;
...
`,_=o.default.div.withConfig({componentId:"zh_mobile_web__sc-a6b2f0d9-7"})`
  ...
  padding: 12px;
`,v=o.default.div.withConfig({componentId:"zh_mobile_web__sc-a6b2f0d9-8"})`
  overflow: hidden;
...
`,k=o.default.footer.withConfig({componentId:"zh_mobile_web__sc-a6b2f0d9-16"})`
  ...
  background: #fff;
`,D=(0,o.default)(s.default.Button.Filled.Primary).withConfig({componentId:"zh_mobile_web__sc-a6b2f0d9-17"})`
  display: flex;
  flex: 1 0 0;
  gap: 4px;
  align-items: center;
